...
@section('content')
    ...
    <div id="wrap-body">
        <div class="chunk">
            ...
            <form id="postform" method="post" action="{{ url('topic/'.$topic->id.'/postThread') }}" enctype="multipart/form-data">
                ...
                <div class="panel" id="postingbox">
                    <div class="inner">
                        ...
                        <fieldset class="fields1">
                            ...
                            <dd style="clear: left;">
                                <dt></dt>
                                <dd><input type="checkbox" name="is_announcement" id="is_announcement">
